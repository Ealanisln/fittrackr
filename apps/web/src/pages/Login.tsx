  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        const errorMessage = result.error.message || result.error.code || 'Error al iniciar sesión';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8 border border-slate-700">
          <h2 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6">Iniciar Sesión</h2>
